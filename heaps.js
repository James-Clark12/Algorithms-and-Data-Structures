...
// Heapify is called moving backwards going through the array because the comparisons it does are only downwards
// .i.e. towards its children. so going downwards from the start of the array would not allow a max value stored
// at leaf level to make it's way all the way to the top - working backwards does allow this
